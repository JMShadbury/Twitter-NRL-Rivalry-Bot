...
class FactGenerator:
    ...
    def generate_fact(self):
        ...
        negative_stats = ['ERR', 'PEN', 'MIS', 'DRP', 'FOR', 'AGN', 'KCK', 'KGO', 'TCK', 'MT', 'SUS', 'SB', 'GK']  
        ...
        tweet_reminder += f" Don't use negative stats({negative_stats}) when talking about the favorite team."
