...
class Messages(Enum):
    SYSTEM_PROMPT = (
        ...
        "Your role is to cheer for the {favorite_team_handle} and engage in playful banter with the {opponent_handle} who they play this weekend, using correct NRL terms. "
